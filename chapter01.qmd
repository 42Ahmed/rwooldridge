...
Trained men received earnings of **6,350** while untrained received **4,550** only. The percentage change is $\%\Delta x =\dfrac{6.35 - 4.55}{4.55} =  39.56\%$ which is practically significant. A difference of 1800 is economically significant, especially for low-income men in 1978.
...
**24%** of the trained men were unemployed while **35%** of the untrained men were unemployed. There is a **11 percentage point change** in unemployment between the two groups.
...
-   **Non-Linearity:** A simple correlation coefficient only measures linear relationships. Because 98.6% of the counties had zero executions, the data is heavily skewed and bounded at zero, meaning any actual relationship between the two variables is almost certainly non-linear.
