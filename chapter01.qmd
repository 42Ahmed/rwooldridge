...
```{r}
#| label: c1_data
df_wage <- wooldridge::wage1
knitr::kable(head(df_wage))
...
```{r}
#| label: c3_data
df_meap1 <- wooldridge::meap01
knitr::kable(head(df_meap1))
...
> (vii) Suppose School A spends \$6,000 per student and School B spends \$5,500 per student. By what percentage does School A’s spending exceed School B’s? Compare this to $100 \times [\log(6,000) – \log(5,500)]$?
...
::: callout-important
Logarithmic approximation fails when percentage change is large (\> 10%)
:::
