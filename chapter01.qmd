...
Trained men received earnings of **6.35** while untrained received \*\*4.55\* only. The percentage change is $\%\Delta x\dfrac{6.35 - 4.55}{4.55} =  39.56\%$ which is practically significant.
...
Number of children is heavily skewed to the left. **1132** women had 0 children while only one woman had a maximum number of **13** children.
...
Having electricity does not have causal effect on womens' number of children. But electricity can be an indidactor to other factors that have causal effect, like socioeconomic status and urban area.
