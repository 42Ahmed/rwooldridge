...
**Change = Time (Longitudinal)**
Tracking the *same* subject across different time periods.
* *Math:* (New - Old) / Old

**Difference = Distinct Groups (Cross-Sectional)**
Comparing *separate* subjects at the *same* point in time.
* *Math:* (Group A - Group B) / Group B
:::
...
The absolute mathematical difference between two rates.

$$\text{Difference in Points} = \text{Rate}_A - \text{Rate}_B$$

**Percentage Difference:**
The relative size of the gap compared to a chosen base group.
